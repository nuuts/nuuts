 ...
 * between SaruulCoind, and SaruulCoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("SaruulCoin-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), SaruulCoin_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/SaruulCoin/SaruulCoin>";
    const std::string URL_WEBSITE = "<https://SaruulCoincore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("SaruulCoin-loadblk");
...
/** Sanity checks
 *  Ensure that SaruulCoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("SaruulCoin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single SaruulCoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(GetArg("-conf", SaruulCoin_CONF_FILENAME)).string());
