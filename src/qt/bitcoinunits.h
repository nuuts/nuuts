...
#ifndef SaruulCoin_QT_SaruulCoinUNITS_H
#define SaruulCoin_QT_SaruulCoinUNITS_H
...
/** SaruulCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SaruulCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SaruulCoinUnits(QObject *parent);

    /** SaruulCoin units.
      @note Source: https://en.SaruulCoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SRC,
...
typedef SaruulCoinUnits::Unit SaruulCoinUnit;

#endif // SaruulCoin_QT_SaruulCoinUNITS_H
