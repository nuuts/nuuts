...
#ifndef SaruulCoin_TEST_SCRIPTNUM10_H
#define SaruulCoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from SaruulCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // SaruulCoin_TEST_BIGNUM_H
