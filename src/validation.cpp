...
#if defined(NDEBUG)
# error "SaruulCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "SaruulCoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SRC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("SaruulCoin-scriptch");
