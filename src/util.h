 ...
 */
#ifndef SaruulCoin_UTIL_H
#define SaruulCoin_UTIL_H
...
extern const char * const SaruulCoin_CONF_FILENAME;
extern const char * const SaruulCoin_PID_FILENAME;
...
{
    std::string s = strprintf("SaruulCoin-%s", name);
