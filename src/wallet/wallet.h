...
#ifndef SaruulCoin_WALLET_WALLET_H
#define SaruulCoin_WALLET_WALLET_H
...
public:
     ...
     * on this SaruulCoin node, and set to 0 for transactions that were created
...
#endif // SaruulCoin_WALLET_WALLET_H
